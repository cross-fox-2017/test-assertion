...
assert.equal(math.add(1), 'masukkkan dua angka');
assert.equal(math.add('q',5), 'masukkkan number');
...
assert.equal(math.substract('q',5), 'masukkkan number');
...
assert.equal(math.multiply('q',5), 'masukkkan number');
...
assert.equal(math.divide('q',5), 'masukkkan number');
